...
const Landing = () => {
    return (
        <div className='landing h-[100vh] text-center flex flex-col justify-center items-center relative'>
            ...
            <p className='text-[whitesmoke] text-2xl max-w-xl my-4'>With over 100 cart from 12+ countries, you're bound to find something that will satisfy your cravings.</p>

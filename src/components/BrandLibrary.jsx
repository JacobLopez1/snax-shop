        ...
        <div className='mx-auto my-20'>
            ...
            <Carousel animation='slide' autoPlay={false} className='w-[50%] mx-auto carousel-wrapper'>
                <div className='flex justify-center'>
                    ...
                    <img className='w-36 h-28' src='https://yt3.ggpht.com/a-/AAuE7mDXWlapAVimlgWOkQYei3cC-kC1C8I-CVHt5w=s900-mo-c-c0xffffffff-rj-k-no' />
                ...
                <div className='flex justify-center'>
                    ...
                    <img className='w-36 h-28' src='https://th.bing.com/th/id/OIP.-m64v-fooiWVRXw-flpTBAHaHa?pid=ImgDet&rs=1' />
